...
export default async function AdminPosts() {
  ...
  return <AdminShell user={user} title="Artigos"><div className="app-content"><div className="page-head"><div><h1 className="app-title">Todos os artigos</h1><p className="muted">Crie, revise, publique e acompanhe o conteúdo da equipe em um só lugar.</p></div><Link className="btn btn-primary" href="/publicar/novo">+ Novo artigo</Link></div><div className="panel" style={{ marginTop: 24 }}><div className="table-wrap"><table className="data-table responsive-table"><thead><tr><th>Título</th><th>Autor</th><th>Categoria</th><th>Status</th><th>Ações</th></tr></thead><tbody>{posts.map((post) => <tr key={post.id}>
